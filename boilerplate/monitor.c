 ...
 * Kernel 6.17 / Ubuntu 24.04 compatible
 */
...
static void timer_callback(struct timer_list *t)
{
    ...
    /*
     * list_for_each_entry_safe allows safe deletion while iterating
     * because it pre-fetches the next pointer before we might free
     * the current entry.
     */
...
static long monitor_ioctl(struct file *f, unsigned int cmd, unsigned long arg)
{
    ...
    /* Ensure container_id is null-terminated */
